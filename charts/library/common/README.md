...
- name: common
  version: 4.5.1
  repository: https://damacus.github.io/charts/charts/
```

## Configuration

The [values.yaml](./values.yaml) file has several commented out suggested values.
...
| addons.vpn | object | See values.yaml | |
