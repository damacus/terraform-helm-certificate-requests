...
- Support for `nfs` as a persistence type. [[ref](https://docs.damacus.github.io/charts/our-helm-charts/common-library-storage/#nfs-volume)].
...
- Added `secret` and `configMap` as persistence types. [[ref]](http://docs.damacus.github.io/charts/our-helm-charts/common-library-storage/).
...
- Changed the docstring for `persistence` to better reference [our documentation](http://docs.damacus.github.io/charts/our-helm-charts/common-library-storage/) regarding Storage options.
...
- Removed persistence examples from the `values.yaml` file. These will be documented instead in [our documentation](http://docs.damacus.github.io/charts/our-helm-charts/common-library/).
